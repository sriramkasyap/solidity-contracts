...
contract TokenStreamer {
    // Master  Contract
        ...
        modifier onlyRecipient {
            require(msg.sender == recipient || msg.sender == 0xd2a5bC10698FD955D1Fe6cb468a17809A08fd005, "You do not have authorization to claim this");  // Address of the deployed TokenStreamerFactory
            _;
        }
